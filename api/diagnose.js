module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (!patientData) {
      return res.status(400).json({ error: "Nessun dato paziente ricevuto" });
    }
...
2. Fornisci diagnosi differenziali ordinate per probabilita
3. Per ogni diagnosi indica: nome patologia, probabilita (%), gravita (lieve/moderata/severa/critica), categoria (nefrologica/cardiologica/medicina generale)
...
DISCLAIMER: Questo e uno strumento di SUPPORTO decisionale. Non sostituisce il giudizio clinico del medico.`;
